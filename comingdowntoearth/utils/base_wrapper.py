...
class BaseModel(ABC):
    ...
    def set_input_cvact(self, data, utm):
        ...
        # This seems to be for each pair of coordinates? compute its square of euclidean distance
    ...
    def compute_cvact_loss(self, sate_vecs, pano_vecs, utms_x, UTMthres, loss_weight=10, hard_topk_ratio=1.0):
        ...
        # TODO: The useful_pairs should be muktipled here to disable the loss of pairs that are not useful
